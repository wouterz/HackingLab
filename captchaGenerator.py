...
def createCaptcha(items, directory, size, number_of_images):
    savedir = "./images/captcha_{}_{}".format(directory, size)
    try:
        os.stat(savedir)
    except:
        os.makedirs(savedir)
...
createCaptcha(choices[choice], choice, size, number_of_images)
